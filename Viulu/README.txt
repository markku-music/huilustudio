...
DEV 2.8: Puhelimen normaalinäkymä skaalautuu nyt näytön leveyden mukaan yläreunasta alaspäin (top-anchored + width-driven). Kehittäjätila säilyttää tilanjaon, jotta säädöt ja viulu näkyvät yhtä aikaa.
