(function () {
  ...
  const STRINGS = {
      ...
      documentTitle: "Pikakirjoitin 3 · 0.17.6.52",
      subtitle: "0.17.6.52 · Kappaleen tiedot uudelleen · Nuottikoko 95 % · Sävellajitietoiset etumerkit · Tabletin PDF / tulostus · FI / EN · OSMD 2.1.2",
      ...
      marcato: "Marcato",
      tenuto: "Tenuto",
      stemDirection: "Varren suunta",
      stemUp: "Varsi ylös",
      stemDown: "Varsi alas",
      slurPlacement: "Slurin suunta",
      slurAbove: "Slur yllä",
      slurBelow: "Slur alla",
    ...
    en: {
      appName: "SwipeScore",
      documentTitle: "SwipeScore · 0.17.6.52",
      subtitle: "0.17.6.52 · Reopen score details · Notation size 95% · Key-aware accidentals · Tablet PDF / print · FI / EN · OSMD 2.1.2",
      ...
      stemUp: "Stem up",
      stemDown: "Stem down",
      slurPlacement: "Slur placement",
      slurAbove: "Slur above",
      slurBelow: "Slur below",
      automatic: "Automatic",
