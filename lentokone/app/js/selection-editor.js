  ...
  class SelectionEditor {
    constructor(options) {
      ...
      root.innerHTML = `
        <button type="button" data-action="enharmonic"
          ...
          <img class="pk-enharmonic-icon" src="app/assets/Enharmoninen.svg"
        ...
        <div class="pk-slur-control">
          <button type="button" data-action="slur"
                  ...
                  aria-expanded="false">
            <img class="pk-slur-icon" src="app/assets/slur.svg"
                 alt="" aria-hidden="true">
          </button>
        ...
        <div class="pk-direction-control pk-stem-direction-control">
          <button type="button" data-action="stem-direction"
            ...
            <img class="pk-direction-icon pk-stem-direction-icon" src="app/assets/stem-auto.svg"
                 alt="" aria-hidden="true">
          </button>
        </div>
        ...
        <div class="pk-direction-control pk-slur-placement-control">
          <button type="button" data-action="slur-placement"
                  ...
                  aria-haspopup="false" aria-pressed="false">
            <img class="pk-direction-icon pk-slur-placement-icon" src="app/assets/slur-auto.svg"
                 alt="" aria-hidden="true">
          </button>
        </div>
        ...
        <button type="button" data-action="beam"
                ...
                aria-pressed="false">
          <img class="pk-beam-icon" src="app/assets/beam-break.svg"
               alt="" aria-hidden="true">
        </button>
        ...
        <button type="button" data-action="rest"
          ...
          <img class="pk-rest-icon" src="app/assets/rest.svg"
               alt="" aria-hidden="true">
        </button>
      ...
      if (beam) {
        ...
        if (beamIcon) {
          beamIcon.src = this.beamMode === "join"
            ? "app/assets/beam-join.svg"
            : "app/assets/beam-break.svg";
        }
      }
    ...
    renderSlurChoices(choices) {
      ...
      items.forEach((choice) => {
        ...
        button.innerHTML = `
          <img src="app/assets/slur.svg" alt="" aria-hidden="true">
    ...
    updateDirectionControls(config) {
      ...
      if (stemIcon) stemIcon.src = "app/assets/stem-" + (this.stemDirection === "mixed" ? "auto" : this.stemDirection) + ".svg";
      ...
      if (slurIcon) slurIcon.src = "app/assets/slur-" + this.slurPlacement + ".svg";
