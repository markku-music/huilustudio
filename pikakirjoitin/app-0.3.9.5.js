...
const PROJECT_APP_VERSION = '0.3.9.5';
...
function startFlickGesture(ev) {
  ...
  // iPadin Safari hyväksyy AudioContextin herätyksen varmimmin suoraan
  // pointerdown-käsittelijässä ennen osoittimen kaappaamista.
  ensureAudio();
  ...
  // kun sormiele alkaa. Kiinteä 0,24 s koeääni vastaa toimivaa 0.3.3.1-versiota.
